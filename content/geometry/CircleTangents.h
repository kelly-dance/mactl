 ...
 * 1 if the circles are tangent to each other (in which case .F = .S and the tangent line is perpendicular to the line between the centers).
 * .F and .S give the tangency points at circle 1 and 2 respectively.
